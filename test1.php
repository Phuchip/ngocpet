                        ...
                        <div class="wp-inner">
                            ...
                            <div id="action-wp" class="fl-right">
                                <div id="advisory-wp" class="fl-left">
                                    ...
                                    <span class="phone">0342966077</span>
                                </div>
                                <div class="zalo-chat-widget" data-oaid="4289860309360302162" data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup="0" data-width="350" data-height="420"></div>
                                        ...
                                        <li>
                                            ...
                                            <div>
                                                <div class="nav-column">
                                                    <h3>Shop cho chó</h3>
                                                    <ul>
                                                        <li><a href="category_product.html">Thức ăn</a></li>
                                                        <li><a href="category_product.html">Quần áo cho chó</a></li>
                                                        <li><a href="category_product.html">Vòng cổ, dây dắt, rọ mõm</a></li>
                                                        <li><a href="category_product.html">Phụ kiện khác</a></li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="nav-column">
                                                    ...
                                                    <ul>
                                                        <li><a href="category_product.html">Thức ăn</a></li>
                                                        <li><a href="category_product.html">Quần áo cho mèo</a></li>
                                                        <li><a href="category_product.html">Vòng cổ, dây dắt, rọ mõm</a></li>
                                                        <li><a href="category_product.html">Phụ kiện khác</a></li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="nav-column">
                                                    ...
                                                    <ul>
                                                        <li><a href="category_product.html">Chim</a></li>
                                                        <li><a href="category_product.html">Hamster</a></li>
                                                        <li><a href="category_product.html">Thú cưng nhỏ</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
                                        <li><a href="gioithieu.html" class="icon">Giới thiệu</a></li>
                        ...
                        <div class="main-content fl-right">
                            <div class="section" id="slider-wp">
                                <div class="section-detail">
                                    ...
                                    <div class="item">
                                        <img src="public/images/slider-3.png" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="public/images/slider-4.png" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="public/images/slider-5.png" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="section" id="feature-product-wp">
                                ...
                                <div class="section-detail">
                                    <ul class="list-item">
                                        ...
                                        <li>
                                           <a href="san_pham_chi_tiet.php?id=<?php echo $row["id_san_pham"];?>" title="" class="thumb">
                                                <img src="./img/<?php 
                                                    if ($row["anh_minh_hoa"]<>"") {
                                            ...
                                            <a href="san_pham_chi_tiet.php?id=<?php echo $row["id_san_pham"];?>" title="" class="product-name"><?php echo $row["ten_san_pham"];?></a>
                                            <div class="price">
                                ...
                                <div class="secion-detail">
                                    <ul class="list-item">
                                        <li>
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="category_product.html" title="">Thức ăn</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Quần áo cho chó</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Vòng cổ, dây dắt, rọ rõm</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Phụ kiện khác</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="category_product.html" title="" class="icon2">Shop mèo cưng</a>
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="category_product.html" title="">Thức ăn</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Quần áo cho mèo</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Vòng cổ, dây dắt, rọ rõm</a>
                                                </li>
                                        ...
                                        <li>
                                            <a href="category_product.html" title="" class="icon2">Shop vật nuôi khác</a>
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="category_product.html" title="">Chim</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Hamster</a>
                                                </li>
                                                <li>
                                                    <a href="category_product.html" title="">Thú cưng nhỏ</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <div class="section-detail">
                                    <ul class="list-item">
                                        <?php
                                            ...
                                            ;?>
                                        <li class="clearfix">
                                            <a href="san_pham_chi_tiet.php?id=<?php echo $row["id_san_pham"];?>" title="" class="thumb fl-left">
                                                <img src="./img/<?php 
                                                    if ($row["anh_minh_hoa"]<>"") {
                                                        echo $row["anh_minh_hoa"];
                                                    } else {
        ...
        <a href="tel:0912870820">
            ...
            <div id="footer-wp">
                <div id="foot-body">
                    ...
                    <div id="foot-bot">
                        <div class="wp-inner">
                            <p id="copyright">© Bản quyền thuộc về Nhóm 7 K20HTTTA</p>
                        </div>
                    </div>
                </div>
            </div>
