                        ...
                        <div class="main-content fl-right">
                            ...
                            <div class="secion-detail">
                                <ul class="list-item clearfix">
                                    <?php
                                        ...
                                        $sql = "
                                            ...
                                            FROM tbl_loai_tin_tuc
                                              WHERE id_loai_tin_tuc = '".$id_san_pham."'
                                        ";
                                    ...
                                    <li>
                                        <a href="" title="" class="bread-crumb"><?php echo $row["ten_loai_tin_tuc"];?></a>
                                    </li>
                                    <?php
                                }
                                    ;?>
                                ...
                                <div class="section-head line">
                                    <?php
                                        ...
                                        $sql = "
                                            SELECT *
                                            FROM tbl_loai_tin_tuc
                                            WHERE id_loai_tin_tuc='".$id_tin_tuc."'
                                        ";
                                        // Hướng dẫn check câu lệnh truy vấn viết đúng hay sai
                                        // var_dump($sql); exit();
                                    ...
                                    ;?>
                                    <h3 class="section-title"><?php echo $row["ten_loai_tin_tuc"];?></h3>
                                    <?php
                                }
                                ;?>
                                </div>
                                <div style="float: left; width: 700px;">
                                    <?php 
                                        ...
                                        $sql = "
                                            SELECT *
                                            FROM tbl_tin_tuc
                                            WHERE id_loai_tin_tuc = '".$id_loai_tin_tuc."'
                                        ";
                                        ...
                                        while ($row = mysqli_fetch_array($noi_dung_tin_tuc)) {
                                    ;?>
                                    <h3><a href="tin_tuc_chi_tiet.php?id=<?php echo $row["id_tin_tuc"];?>&name=<?php echo $row["id_loai_tin_tuc"];?>><font color="red"><?php echo $row["tieu_de"];?></font></a></h3>
                                    <table>
                                        <tr>
                                            <td>
                                                <img src="./img/<?php 
