                            ...
                            <div class="fixnav">
                                <div class="fl-left">
                                    <ul id="main_menu">
                                        ...
                                        <li>
                                            <a href="tin_tuc.php" class="active">Tin tức</a>
                            ...
                            <div class="section" id="feature-product-wp">
                                ...
                                <div class="section-detail">
                                    ...
                                    <div class="h-box-news nomar-l">
                                        <div class="h-title-box-news" id="box0">
                                          <h2 class="h-title"><a class="txt_pink" href="tin_khuyen_mai.php">Tin khuyến mãi</a></h2>
                                        </div>
                                        <div class="h-content-box-news" id="getA1">
                                            <?php
                                            // 1. Chuỗi kết nối đến CSDL
                                                ...
                                                $sql = "
                                                    SELECT *
                                                    FROM tbl_tin_tuc
                                                    WHERE ghi_chu='".$id."' AND id_loai_tin_tuc='".$id."'
                                                ";
                                            ...
                                            ;?>
                                            <div class="box-top">
                                                <a href="tin_tuc_chi_tiet.php?id=<?php echo $row["id_tin_tuc"];?>&name=<?php echo $row["id_loai_tin_tuc"];?>" class="img">
                                                        <img src="./img/<?php 
                                                    if ($row["anh_minh_hoa"]<>"") {
                                                ...
                                                <div class="right-side">
                                                    <a href="tin_tuc_chi_tiet.php?id=<?php echo $row["id_tin_tuc"];?>&name=<?php echo $row["id_loai_tin_tuc"];?>"><font color="red"><?php echo $row["tieu_de"];?></font></a>
                                                    <br>
                                                    <span class="summary"><?php echo $row["mo_ta"];?></span>
                                                    <a href="/tin-khuyen-mai/xuan-canh-ty-sale-nhu-y-13/1-22/1-1118.html" class="more"><span>»</span>Xem tiếp</a>
                                                </div>
                                            </div>
                                            <?php
                                            }
                                            ...
                                            // 1. Chuỗi kết nối đến CSDL
                                                ...
                                                $sql = "
                                                    SELECT *
                                                    FROM tbl_tin_tuc
                                                    WHERE id_loai_tin_tuc='".$id."' AND ghi_chu is null
                                                ";
                                            ...
                                            ;?>
                                                <li>
                                                    <a href="tin_tuc_chi_tiet.php?id=<?php echo $row["id_tin_tuc"];?>&name=<?php echo $row["id_loai_tin_tuc"];?>"><?php echo $row["tieu_de"];?></a>
                                                </li>
                                            <?php
                                            }
                                            ;?>
                                        </ul>
                                        <script>getArticleList("/ajax/get_json.php?action=article&action_type=list&type=article&catId=1&show=6&sort=order",'#getA1',6)</script>
                                    </div>
                                </div>

                                      <div class="h-box-news ">
                                        <div class="h-title-box-news" id="box1">
                                          <h2 class="h-title"><a class="txt_pink" href="dich_vu_pet.php">Dịch vụ Pet</a></h2></div>
                                      ...
                                      <div class="h-box-news nomar-l">
                                        ...
                                        <div class="h-title-box-news" id="box2">
                                          <h2 class="h-title"><a class="txt_pink" href="tin_su_kien.php">Tin sự kiện</a></h2></div>
                                      ...
                                      <div class="h-box-news ">
                                        ...
                                        <div class="h-title-box-news" id="box3">
                                          <h2 class="h-title"><a class="txt_pink" href="thong_tin_pet.php">Thông tin hữu ích cho thú cưng</a></h2></div>
                                        ...
                                        <div class="h-content-box-news" id="getA6">
                                            ...
                                            ;?>
                                                <li>
                                                    <a href="tin_tuc_chi_tiet.php?id=<?php echo $row["id_tin_tuc"];?>&name=<?php echo $row["id_loai_tin_tuc"];?>&name=<?php echo $row["id_loai_tin_tuc"];?>"><?php echo $row["tieu_de"];?></a>
                                                </li>
                                            <?php
                                            }
                                            ;?>
...
<div class="hotline-phone-ring-wrap">
  ...
  logged_in_greeting="Chào bạn ,Mình là Ngọc"
  logged_out_greeting="Chào bạn ,Mình là Ngọc">
